...
const Header = () => {
  ...
  return (
    <>
      <Navbar />
      <div
        className="h-[48rem] bg-cover bg-center] relavive"
        style={logoHeader02}
      >
        <header className=" flex flex-col gap-8 justify-center items-center h-full">
          ...
          <div className="h-1/2 x:h-0 x:relative">
            <div className="bg-primary w-full p-10 flex flex-col justify-center items-center gap-3 mdd:w-[50rem] mdd:flex-row mdd:gap-3 mdd:space-x-3 x:flex-row x:gap-9 x:space-x-5 x:w-auto x:h-[10rem] x:absolute x:top-[6rem] x:left-[-32rem] ;">
              <select
                id="underline_select"
              ...
              <input
                ...
                className="border-1 w-[11rem] h-10 border-b-2 border-gray-700 p-3 text-slate-400"
              />
              <div className="bg-invert w-12 h-12 flex justify-center items-center rounded-full hover:bg-red-700 mdd:h-10 x:h-12 x:ml-3">
                <svg
